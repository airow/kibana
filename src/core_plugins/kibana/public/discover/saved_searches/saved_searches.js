...
import rison from 'rison-node';/*ÓÃÓÚ½âÎöµØÖ·À¸_a²ÎÊý»ñÈ¡µ±Ç°Ë÷ÒýµÄId*/
...
module.service('savedSearches', function (Promise, config, kbnIndex, es, createNotifier, SavedSearch, kbnUrl,$location) {
  ...
  this.find = function (searchString, size = 100) {
    debugger;
    let search=$location.search();//»ñÈ¡µØÖ·À¸²éÑ¯²ÎÊýangular $location ×é¼þ
    let searchAJson=rison.decode(search["_a"]); //Ê¹ÓÃrison½âÂëµØÖ·À¸²ÎÊý
